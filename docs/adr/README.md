...
| [0040](./0040-ci-gates-are-advisory-while-the-repository-is-private.md)                      | The CI gates are advisory while the repository is private on the free plan                                                                         | superseded |
...
| [0086](./0086-the-gates-become-blocking-on-a-public-repository.md)                           | The gates become blocking, because the repository is public (supersedes 0040)                                                                      | accepted   |
| [0087](./0087-the-vhost-reuses-the-hosts-wildcard-certificate.md)                            | The vhost reuses the host's wildcard certificate, and issues none of its own                                                                       | accepted   |
| [0088](./0088-static-assets-are-cached-and-metered-apart.md)                                 | Static assets are cached and metered apart from the application                                                                                    | accepted   |
| [0089](./0089-a-scrollport-is-a-containing-block.md)                                         | A scrollport is a containing block                                                                                                                 | accepted   |
| [0090](./0090-the-org-chart-stops-at-the-office-boundary.md)                                 | The org chart stops at the office boundary                                                                                                         | accepted   |
| [0091](./0091-the-cra-read-port-gains-an-open-ended-period-bound.md)                         | The Cra read port gains an open-ended period bound                                                                                                 | accepted   |
| [0092](./0092-small-images-are-emitted-as-files-not-inlined.md)                              | Small images are emitted as files, never inlined                                                                                                   | accepted   |
| [0093](./0093-a-handler-may-branch-on-role-to-shape-a-response.md)                           | A handler may branch on role to shape a response, never to authorize                                                                               | accepted   |
| [0094](./0094-a-consultants-manager-is-in-the-consultants-office.md)                         | A consultant's manager is in the consultant's own office                                                                                           | accepted   |
| [0095](./0095-not-computed-and-zero-are-different-answers.md)                                | "Not computed" and "zero" are different answers                                                                                                    | accepted   |
| [0096](./0096-the-company-news-carousel-gets-fixed-arrows-and-a-css-timer.md)                | The company-news carousel gets fixed arrows, a CSS timer, and a narrow-width fallback                                                              | accepted   |
| [0097](./0097-one-call-to-action-per-actionable-cra.md)                                      | One call to action per actionable Cra, on the consultant dashboard                                                                                 | accepted   |
| [0098](./0098-the-manager-dashboard-chart-becomes-a-staffing-snapshot.md)                    | The manager dashboard's chart becomes a staffing snapshot; billing's is a stated absence                                                           | accepted   |
...
| [0102](./0102-invoice-issuance-serializes-on-a-key-lock-and-a-row-lock.md)                   | Invoice issuance serializes on an advisory key lock and a `FOR UPDATE` row lock, not a version column                                              | accepted   |
| [0103](./0103-cra-writes-serialize-on-a-row-lock-and-an-advisory-lock.md)                    | Cra writes (validate/refuse/recordMonth) serialize on a row lock and an advisory lock, a separate scheme from 0102's                               | accepted   |
| [0104](./0104-a-validated-cras-own-status-is-the-replay-receipt.md)                          | A validated Cra's own status is the replay receipt, not whether billing drafted an invoice                                                         | accepted   |
| [0105](./0105-assignment-validation-covers-the-whole-interval.md)                            | Assignment validation covers the whole interval: departure's open end, habilitation's gaps                                                         | accepted   |
| [0106](./0106-assignment-writes-serialize-on-an-advisory-lock.md)                            | Assignment writes serialize on an advisory lock; recorded-days check weighs every assignment, not just the one edited                              | accepted   |
| [0107](./0107-the-issued-document-freezes-its-seller-vat-breakdown-and-due-date.md)          | The issued document freezes its seller (at drafting), VAT breakdown, and due date (at issuance)                                                    | accepted   |
| [0108](./0108-every-aggregate-value-is-defensively-copied-at-its-boundary.md)                | Every aggregate value — timestamps, addresses, line origins, VAT treatments — is defensively copied at its boundary                                | accepted   |
| [0109](./0109-dashboard-aggregates-are-scoped-queries-not-capped-pages.md)                   | Dashboard aggregates are scoped queries, never a capped page                                                                                       | accepted   |
| [0110](./0110-problem-details-are-validated-at-the-client-boundary.md)                       | Problem details are validated at the client boundary, with a named rule against contracts importing a module                                       | accepted   |
| [0111](./0111-response-dtos-live-in-the-shared-contract.md)                                  | Response DTOs live in the shared contract, as explicit interfaces                                                                                  | accepted   |
| [0112](./0112-persona-changes-broadcast-across-tabs-through-storage.md)                      | Persona changes broadcast across tabs through `localStorage`, verified without a browser                                                           | accepted   |
| [0113](./0113-mutations-invalidate-every-projection-they-actually-change.md)                 | Mutations invalidate every projection they actually change, named by a table read off the server                                                   | accepted   |
| [0114](./0114-html-construction-is-private-static-not-commented-internal.md)                 | `Html`'s construction and unwrapping are compiler-enforced, not `@internal`-commented                                                              | accepted   |
| [0115](./0115-route-schemas-move-by-real-consumer-and-phase-2-is-scoped-down.md)             | Route schemas move by real consumer count; phase 2's file-size premise is stale                                                                    | accepted   |
| [0116](./0116-list-enrichment-uses-module-owned-read-projections.md)                         | List enrichment uses module-owned read projections                                                                                                 | accepted   |
...
| [0075](./0075-the-vulnerability-management-procedure-and-where-it-lives.md)                  | The vulnerability-management procedure, and where it lives (point 1 superseded by ADR-0119)                                                        | accepted   |
