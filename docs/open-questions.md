...
| 04/09/2026 | **`apps/web/src/assets/security-alert.webp` is untracked, unreferenced and un-ignored.** It appeared in the working tree during the QA round 4 session, from outside that branch's work. Nothing in `.ts`, `.tsx`, `.md` or `.json` names it, so Vite emits nothing for it and it ships nowhere.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | A file in neither `git` nor `.gitignore` is a file the next `git add .` commits by accident, into `apps/web/src/`, on a public repository. Harmless as an image; not harmless as a precedent, on a repository whose thesis is that gates beat discipline.                                                                                                                                                                                                                                                                                                                 | **Open — Clement's call, by 30/09/2026 (Phase 10, task 10.1).** Two clean answers and one bad one: delete it, or wire it to the screen it was meant for (ADR-0092's asset path) — the bad one is leaving it exactly as it is. Recorded rather than acted on because it is not this branch's file.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
