...
Both are the same underlying gap — no Playwright, no Postgres, this session — so one row carries
both:

| Since      | Question                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Impact if wrong                                                                                                                                                                                                                                                    | Status                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 04/09/2026 | **QA round 5 shipped six items and two new integration tests with no Postgres and no Playwright available in the session that wrote them.** The two `staffing-snapshot` tests (ADR-0098) have never run; none of the six items' rendered output was seen in a browser; and `8.4-dashboard-{manager,consultant,billing}.png`, `10.4-dashboard-manager-en-attente.png`, the four `4.2-shell-*.png` and `4.5-shell-mobile-sheet.png` now show a screen this round changed. | A green `pnpm run test` and a clean `tsc`/`eslint`/`prettier` pass are not the same claim as "this runs" or "this renders as described" — the gap this repository's own `rules-auditor` precedent (04/09/2026, above) already caught once, for a different reason. | **Open — the next session with Postgres and Playwright access, before this branch merges to `main`.** Run `pnpm run test:int` for the two new tests; run the `journeys`, `desktop` and `mobile-shell` Playwright projects and re-capture the nine named screenshots if their content genuinely changed (`animations: 'disabled'`, same paths, per each spec file's own convention) rather than leaving them to drift further. |
