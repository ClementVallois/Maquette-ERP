...
describe('frenchDate and frenchMonth', () => {
  ...
  it('names the month, from a string or from a Period', () => {
    expect(frenchMonth('2026-06')).toBe('juin 2026');
    expect(frenchMonth(period(2026, 1))).toBe('janvier 2026');
    expect(frenchMonth(period(2026, 12))).toBe('décembre 2026');
  });
});
...
describe('frenchWeekday', () => {
  it('starts the week on Monday', () => {
    ...
    expect(frenchWeekday(isoDate('2026-06-01'))).toBe('lundi');
    expect(frenchWeekday(isoDate('2026-06-06'))).toBe('samedi');
    expect(frenchWeekday(isoDate('2026-06-07'))).toBe('dimanche');
  });
});
