...
| ----------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Plus de deux missions dans une même journée                                   | La demi-journée est l'unité de stockage (ADR-0012), donc une journée a deux emplacements et une troisième mission n'a nulle part où aller. La grille de saisie le rend visible plutôt que de le cacher derrière un champ de quantité                                                                                                                                                                                                                                                                                                        | Première facturation à l'heure — c'est le même seuil que celui des trois moteurs de facturation (ADR-0050)                                                                                                               |
...
| Thème sombre (bascule utilisateur clair/sombre)                               | La direction visuelle retient une palette claire unique avec une sidebar sombre fixe, non bipolaire : un second jeu de tokens testé sur chaque composant double l'effort visuel pour un outil à usage interne prolongé, pas un produit grand public                                                                                                                                                                                                                                                                                         | Première demande réelle d'un utilisateur en usage prolongé, ou premier composant shadcn où les deux jeux de tokens existent déjà sans coût supplémentaire                                                                |
