...
/** `GET /api/v1/consultants` (item 7, QA round 1) — a manager or billing persona's own office
 * roster, consultants only (never the manager asking, never another office). */
