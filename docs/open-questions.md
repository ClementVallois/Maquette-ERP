...
| 25/08/2026 | **`GET /api/v1/cras/:period/grid` carries no `validatedBy`, so the SPA's validated banner cannot name who validated the month**, though task 6.4's prose asks for one. Verified against the route's own object literal (`routes/api.ts`), not assumed from the composition type. The established French copy (`LABELS.cra.readOnly.validated`) does not actually need a name — it already reads "un relevé de temps validé est immuable (ADR-0005)" with no placeholder — so the gap is silent rather than a broken sentence.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Low today (the banner reads correctly without a name); if a future demo beat wants to say who validated a month, the fix is either a second `GET /api/v1/cras/:id` fetch (`craId` is already known) or adding `validatedBy` to the grid route's own response — a producer decision, not the SPA's to make unilaterally.                                                                                                                                                                                                                                                   | Not decided here. Resolve **in Phase 7 or 8** if the pré-facturier's or invoice detail's own name-resolution work (`consultantName` already exists there) makes a shared answer obvious. Dated 25/08/2026.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 25/08/2026 | **The manager-facing "CRA" nav entry (`config/navigation.ts`'s `cra-office`, built in Phase 4) still has no working destination after Phase 6.** `/cra`'s list now renders correctly for a manager (`GET /api/v1/cras` scopes to the office), but its "Ouvrir" action is suppressed for every role but `consultant` (this phase's own reasoning: the grid it would open is `forRoles('consultant')` only) — so a manager visiting `/cra` sees a real, correctly-scoped list with no action column at all.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | A manager persona (Bruno, Emma) following the nav entry Phase 4 built for them reaches a list that does nothing — not broken, but not useful either, and this file's own row of 24/08/2026 already flagged this nav entry's ultimate destination as undecided before Phase 6 existed.                                                                                                                                                                                                                                                                                     | Not decided here — Phase 7's pré-facturier ("Les CRA du mois" table, with consultant names and a real decide action) is the manager-facing screen this nav entry may actually want to point at, but reassigning `cra-office`'s path is a navigation decision outside Phase 6's grid-building scope. Resolve **in Phase 7, task 7.1**. Dated 25/08/2026.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
